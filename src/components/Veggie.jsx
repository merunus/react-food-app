...
function Veggie() {
    ...
    const getVeggie = async () => { // async function getPopular() {}
        ...
        if(check) {
            ...
            const resp = await fetch(`https://api.spoonacular.com/recipes/random?apiKey=${key}&number=12&tags=vegetarian`) // apiKey=${process.env.REACT_APP_API_KEY}               
